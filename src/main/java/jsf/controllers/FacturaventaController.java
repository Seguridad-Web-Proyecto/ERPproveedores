...
public class FacturaventaController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Factura de venta creada con exito!");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Factura de venta editada con exito!");
            return "List";
        } catch (Exception e) {
            JsfUtil.addSuccessMessage("¡Lo sentimos la operación no pudo completarse intente mas tarde!");
            return "List";
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡F<ctura de venta eliminada con exito!");
